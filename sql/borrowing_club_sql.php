<?php
	...
	if (!$borrow_id) {
        $sql="INSERT INTO borrowing_list (Club_ID, Borrow_date, Return_date, Space_ID) VALUES ('".$_SESSION['uid']."', '".$borrow_date."', '".$return_date."', '".$sp."');";
        ...
        $sql = "UPDATE borrowing_list SET Club_ID = '".$_SESSION['uid']."', Borrow_date = '".$borrow_date."', Return_date = '".$return_date."', Space_ID = '".$event_place."'WHERE borrowing_list_ID = ".$borrow_id.";";
    }
