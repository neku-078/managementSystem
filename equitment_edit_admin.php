                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <form>
                                            ...
                                            <div class="form-inline">
                                                <p>器材名稱：<input type="text" class="form-control form-control-sm bg-light col-md-10"/></p>
                                            </div>
                                            <div class="form-inline">
                                                <p>數量：<input type="text" class="form-control form-control-sm bg-light col-md-5"/></p>
                                            </div>
                                            ...
                                            <div class="input-group" style="height: 25px; margin-bottom: 15px; display: flex;">
                                                ...
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="destory_state">
                                                    <label class="custom-control-label" for="destory_state">已損壞</label>
                                                </div>
                                            </div>
                                            <!--//確定修改-->
